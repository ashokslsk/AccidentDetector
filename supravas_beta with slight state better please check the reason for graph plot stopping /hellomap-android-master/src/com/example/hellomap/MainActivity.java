...
public class MainActivity extends FragmentActivity implements LocationListener,SensorEventListener,AccelerometerListener{
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(!init){
            mView = mGraph.getGraph();
            ll.addView(mView);
            init = true;
        }else{
        	mGraph.deleteOldestValues();
        	ll.removeAllViews();
        	mView = mGraph.getGraph();
          	ll.addView(mView);
          	mView.repaint(TRIM_MEMORY_RUNNING_MODERATE, TRIM_MEMORY_MODERATE, TRIM_MEMORY_MODERATE, TRIM_MEMORY_MODERATE);       	
    ...
    protected void onResume() {
        super.onResume();
        sMngr.registerListener(MainActivity.this, snsr,SensorManager.SENSOR_DELAY_FASTEST);
       ...
       /* boolean enabledWiFi = service
        ...
        if (!enabledGPS) {
        	new AlertDialog.Builder(this)
	           .setMessage("GPS is not available would you like to open Settings")
	           .setCancelable(false)
        	...
        	Toast.makeText(this, "GPS signal available found", Toast.LENGTH_LONG).show();
        }
